...
<div className="card bg-base-100 w-96 shadow-xl" key={index}>
  ...
  <div className="card-body">
    ...
    <button className='btn btn-ghost ' onClick={addfav}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-suit-heart" viewBox="0 0 16 16">
